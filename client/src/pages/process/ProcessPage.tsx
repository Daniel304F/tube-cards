      ...
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="flex items-start justify-between gap-4">
          <div className="min-w-0">
            ...
            <h1 className="text-xl md:text-2xl font-bold text-text-base truncate">
              {result.video.title}
            </h1>
          </div>
          <button
        ...
        <section>
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-lg font-semibold text-text-base">Summary</h2>
          </div>
          <div className="rounded-lg border border-border bg-white p-5 shadow-sm">
            <div className="prose prose-sm max-w-none text-text-base whitespace-pre-wrap leading-relaxed">
  ...
  return (
    <div className="max-w-xl mx-auto">
      <div className="text-center mb-8">
        <div className="inline-flex items-center justify-center size-16 rounded-2xl bg-brand-surface mb-4">
          <MonitorPlay className="size-8 text-brand" />
        </div>
        <h1 className="text-2xl md:text-3xl font-bold text-text-base mb-2">
          Process a Video
        </h1>
      ...
      <form onSubmit={(e) => void handleSubmit(e)} className="space-y-4">
        <div>
          <label htmlFor="youtube-url" className="block text-sm font-medium text-text-base mb-1">
            YouTube URL
          </label>
          <input
            id="youtube-url"
